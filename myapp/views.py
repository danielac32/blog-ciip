...
def index(request):
    carousel_images = [
        {'src': 'assets/images/ima/IMG_20250224_125102_654.png', 'alt': 'image1', 'caption': 'Caption 1'},
        {'src': 'assets/images/ima/IMG_20250224_125111_832.png', 'alt': 'image2', 'caption': 'Caption 2'},
        {'src': 'assets/images/ima/IMG_20250224_125121_313.png', 'alt': 'image3', 'caption': 'Caption 3'},
        {'src': 'assets/images/ima/IMG_20250224_131126_554.jpg', 'alt': 'image4', 'caption': 'Caption 4'},
        {'src': 'assets/images/ima/IMG_20250224_125433_462.png', 'alt': 'image5', 'caption': 'Caption 5'},
    ]
...
def create(request):
    if request.method == 'POST':
        try:
            ...
            post = Post(postname=postname,content=content,category=category,user=request.user)
            post.save()
            for image in images:
